...
//	    				if (Data.getGroupList().get(i)
//	    						.equals(extras.get("selectedGroup"))) {
//	    					this.groupSpin.setSelection(i);
//	    					break;
//	    				}
//	    			}
//	            }
...
//			for (int i = 0; i < Data.getGroupList().size(); i++) {
//				if (Data.getGroupList().get(i)
//						.equals(data.getExtras().get("selectedGroup"))) {
//					this.groupSpin.setSelection(i);
//					break;
//				}
//			}
	...
	private void allAction() {
		...
		// Go to TaskModifyView when click Add Task
		...
		taskListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				String itemColla = new String();
				

				Log.i("itemColla Size", itemTask.getCollaborators().size() + "");
				...
				for (int i = 0; i < itemTask.getCollaborators().size(); i++) {
					...
					Log.i("Each item", itemColla);

				}
				
				
				
				Log.i("ID", itemTask.getId());
				Log.i("itemStatus", itemStatus);
				Log.i("Grouping", itemGroup);
				Log.i("Collap", itemColla);
...
//				Log.i("After clear", Data.getTaskList().size() + "");
		...
		sortSpin.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				String item = (String) sortSpin.getItemAtPosition(arg2);
				Log.i("Inside SortSpin", "atStart sort spin");
				Log.i("Item", item);
